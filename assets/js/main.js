...
$(function() {
    $("#S1A7content1").hover(
        function() { $("#S1Arow7img1").show(); },
        function() { $("#S1Arow7img1").hide(); }
    );

});
$(function() {
    $("#S1A7content2").hover(
        function() { $("#S1Arow7img2").show(); },
        function() { $("#S1Arow7img2").hide(); }
    );

});
$(function() {
    $("#S1A7content3").hover(
        function() { $("#S1Arow7img3").show(); },
        function() { $("#S1Arow7img3").hide(); }
    );
...
function notice() {
    $("#S2Aanalysisicon").click(function() {
        if (window.S2Aanalysis == 1) {
            $("#S2Aanalysiscont").animate({ height: "200px" });
            window.S2Aanalysis = 0;
        } else if (window.S2Anotice == 0) {
            $("#S2Aanalysiscont").animate({ height: "0px" });
            window.S2Aanalysis = 1;
        }

    });
    $("#S2Anotice").click(function() {
        if (window.S2Anotice == 1) {
            $("#S2AnoticeText").animate({ height: "123px" });
            window.S2Anotice = 0;
        } else if (window.S2Anotice == 0) {
            $("#S2AnoticeText").animate({ height: "0px" });
            window.S2Anotice = 1;
        }
    ...
    $("#S2Dnotice").click(function() {
        if (window.S2Dnotice == 1) {
            $("#S2DnoticeText").animate({ height: "50px" });
            window.S2Dnotice = 0;
        } else if (window.S2Dnotice == 0) {
            $("#S2DnoticeText").animate({ height: "0px" });
            window.S2Dnotice = 1;
        }
    ...
    $("#S2Bnotice").click(function() {
        if (window.S2Bnotice == 1) {
            $("#S2BnoticeText").animate({ height: "123px" });
            window.S2Bnotice = 0;
        } else if (window.S2Bnotice == 0) {
            $("#S2BnoticeText").animate({ height: "0px" });
            window.S2Bnotice = 1;
        }
